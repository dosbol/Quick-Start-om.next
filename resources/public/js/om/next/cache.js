...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__18126 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__18127 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__18127,x_SINGLEQUOTE__18126,this$){
return (function (p1__18125_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__18125_SHARP_,id_SINGLEQUOTE__18127),id,x_SINGLEQUOTE__18126);
});})(id_SINGLEQUOTE__18127,x_SINGLEQUOTE__18126,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__18126);
}
